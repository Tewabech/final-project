...
function Quiz() {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        ...
        setError('Using mock questions due to API limit or error.');
      } finally {
        setLoading(false);
      }
    };
  ...
  if (!questions || questions.length === 0)
    return <p className="text-center mt-10 text-red-600">No questions available.</p>;
